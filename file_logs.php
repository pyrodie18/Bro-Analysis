...
function LoadBroFilesLogs($fileName) { 
/**
 * This file contains all of the functionality to import bro file logs into the database
 ...
 */
	...
	print("Importing filess log file $fileName \n");
